...
\begin{rSection}{Award and Recogition}
    % \begin{multicols}{1}
        \begin{itemize}
            ...
            \item Outstanding Graduate, ShanghaiTech University, 2019. 
        \end{itemize}
    % \end{multicols}
