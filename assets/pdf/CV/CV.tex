...
\address{Email: \href{mailto:contact@junyansu.com}{contact@junyansu.com} }
% \\ \href{https://linkedin.com/in/linkedinURL}{linkedin.com/in/linkedinURL}   %
\address{Homepage: \href{https://www.junyansu.com}{www.junyansu.com}}
% 项目经历标题格式定义（可复用）
...
\begin{rSection}{Journal Articles}
    ...
    \begin{enumerate}
        ...
        \item \underline{Junyan Su}, Qiulin Lin, and Minghua Chen. Optimizing Carbon Footprint in Long-Haul Heavy-Duty E-Truck Transportation. {\emph{Nature Communications}}, 2025. 
        \\ \textcolor{blue}{Nature Communitions Editors' Highlights in Engineering and Infrastructure.}
...
\begin{rSection}{Award and Recogition}
    % \begin{multicols}{1}
    % \begin{itemize}
        \textbf{Academic Awards/Recogitions:}
        \begin{itemize}
            \item Nature Communications Editors' Highlights in Engineering and Infrastructure, 2025 
